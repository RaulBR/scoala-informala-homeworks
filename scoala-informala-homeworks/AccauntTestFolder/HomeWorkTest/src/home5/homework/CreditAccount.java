...
/**
 * This class is a chiled class of{@link AbstractAccaunt} and it models a credit
 * account. It does te folowing:
 * 
 * @Raul
 */
public class CreditAccount extends AbstractAccaunt {
	 ...
	 * 
	 * @param creditMoney
	 *            the amount of money requested as a credit
	 * @param days
	 *            the amount of days till payment
	 * 
	 * @Raul
	 */
	 ...
	 * 
	 * @param creditMoney
	 *            the amount of mony credited.
	 * @param daysFormCredit
	 *            the amount of days elapsed form credit withdrawal.
	 * 
	 * @Raul
	 */
	public void payCredit(float creditMoney, int daysFormCredit) throws InsuficentMoneyAddedException {
		if (daysFormCredit > days && creditMoney < (money + getBalance() * (days - daysFormCredit) * 1f / 100f)) {
			...
			addMoney(latePenalty(creditMoney, daysFormCredit));
		}
